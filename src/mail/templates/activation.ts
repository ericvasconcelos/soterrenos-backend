export const activationTemplate = (subject, name, activationUrl) => `
<!DOCTYPE html>
<html lang="pt-BR">
  <head>
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%; border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                    ...
                    <tr>
                      <td valign="top" style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                        ...
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0 0 15px; color: #333;">Clique no botão abaixo para ativar sua conta:</p>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td align="center" bgcolor="#513e9f" valign="top" style="font-family: sans-serif; font-size: 14px; vertical-align: top; border-radius: 5px; text-align: center; background-color: #513e9f;">
                                        <a href="${activationUrl}" target="_blank" style="border: solid 1px #513e9f; border-radius: 5px; box-sizing: border-box; color: #ffffff; cursor: pointer; display: inline-block; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-decoration: none; text-transform: capitalize; background-color: #513e9f; border-color: #513e9f;">Ativar minha conta</a>
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
